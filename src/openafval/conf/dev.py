...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-$s(8&ko1oc4vx#kck18c9$hyrvhmdi%knbnz@*_tpll#&dp!$e",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "openafval")
os.environ.setdefault("DB_USER", "openafval")
os.environ.setdefault("DB_PASSWORD", "openafval")
