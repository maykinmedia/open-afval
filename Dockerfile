...
COPY --from=frontend-build /app/src/openafval/static /app/src/openafval/static
...
LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://github.com/maykinmedia/open-afval" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="openafval"
